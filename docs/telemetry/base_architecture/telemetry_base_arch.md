...
| :---     | :---       | :---         | :---                            |
| WIP      | 2026/06/04 | Jim Harford  | Under HEAVY construction        |
...
## Conventions
The key words shall (shall, SHALL, shall not, SHALL NOT), Should (should, SHOULD, should not, SHOULD NOT), and may (may, MAY) are to be interpreted as described. 
...
**To Be Done** ideally we simply pull in another md file for license*
